      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-white tracking-tight">Live Attendance & Geofence Feed</h1>
          </div>
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-xs font-medium text-slate-300 hover:text-white flex items-center gap-2 self-start sm:self-auto transition-colors"
        >
